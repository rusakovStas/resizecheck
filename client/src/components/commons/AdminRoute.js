...
const AdminRoute = ({ isAuthentifacated, hasRoleAdmin, component: Component, ...rest}) => (
    <Route {...rest} render={props => isAuthentifacated && hasRoleAdmin ? <Component {...props} /> : <Redirect to="/" /> } />
);
